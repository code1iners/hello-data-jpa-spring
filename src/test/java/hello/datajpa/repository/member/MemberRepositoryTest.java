...
//        }
        ...
        /**
         * There are SQL optimization limitations.
         */
        List<NestedClosedProjections> resultNested = memberRepository.findProjectionsByUsername("member1", NestedClosedProjections.class);
